"""
Django settings for billing_track project.
...
SECRET_KEY = 'django-insecure-496+r$(hhc%mb6pb1e1g%^4te70u)wr6#x)-ptq4x2ih$mw+w@'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = [host, '0.0.0.0','localhost'] #remember to remove my IP
...
ROOT_URLCONF = 'billing_track.urls'
...
WSGI_APPLICATION = 'billing_track.wsgi.application'
